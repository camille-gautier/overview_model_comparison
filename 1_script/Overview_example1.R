...
#FUSE
fuse_path="0_data/Example_1/FUSE/output/CAN_01DG003_84_runs_best.nc"
...
#Shapefiles
basin_shp="0_data/Example_1/Shapefiles/CAN_01DG003_distributed_basin.shp"
river_shp="0_data/Example_1/Shapefiles/CAN_01DG003_distributed_river.shp"

#Output_path
output_path="2_output/Example_1/"
...
read_results_models <- function(model_path_list, basin_info) {
  ...
  if (model_path_list$MESH!=""){
    ...
    if (file.exists(file =paste0(mesh_forcing,"MESH_forcing.nc"))==TRUE){
      nc_forcing=nc_open(paste0(mesh_forcing,"MESH_forcing.nc"))
